...
import Board from "@/components/templates/DashboardColumnView/Board";
import { StrictModeDroppable } from "@/components/templates/StrictModeDroppable";
import { changePosition } from "@/logic/store/slices/boardSlice";
          ...
          >
            {isLoading ? (
              <div className="absolute w-full h-full flex justify-center items-center z-0">
                <Icon iconName="Loading" className="text-primary" />
              </div>
            ) : isError ? (
